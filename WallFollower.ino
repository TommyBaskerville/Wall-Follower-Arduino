...
AF_DCMotor motor3(1, MOTOR34_64KHZ); // Define motor #1, 64KHz pwm
AF_DCMotor motor4(2, MOTOR34_64KHZ); // Define motor #2, 64KHz pwm

int WF_LEFT_US_SENSOR_TRIG = 14;
int WF_LEFT_US_SENSOR_ECHO = 15;
int WF_FRONT_US_SENSOR_TRIG = 16;
int WF_FRONT_US_SENSOR_ECHO = 17;

int NO_OBSTACLE = 0;
int OBSTACLE = 1;

int WF_DISTANCE = 7;
int WF_FRONT_DISTANCE = 13;
...
//---------------------------------------------------------------------------//
NewPing dist45(A4, A5, 200);//(trig,echo,dist max)
int DIS = 7; //Distancia de sensor 45
float rightSensor;
//---------------------------------------------------------------------------//
int WF_Left = 0;
int WF_Front = 0;
